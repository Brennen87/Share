...
import InboxProjectsList from '../../InboxProjectsList';
...
export const InboxProjects = ({
  ...
  return (
    <section className="inbox_projects">
      <div className="inbox_projects__top">
        <div className="inbox_projects__project" onClick={() => toggleList(!show)}>
          <div className="inbox_projects__project_title">Projects</div>
          <svg
            width="12"
            height="7"
            viewBox="0 0 12 7"
              ...
              mobile={
                <div
                  className={classnames(
                    'inbox_projects__mobile_list',
                    show && 'inbox_projects__mobile_list__active'
                  )}
                >
                  <InboxProjectsList
        ...
        {isCustomer && (
          <Link className="inbox_projects__button" to="/projects/create">
            New Project
          </Link>
        )}
      </div>
      <ScreenResolver
        large={970}
        desktop={
          <div className="inbox_projects__desktop_list">
            <InboxProjectsList
              toggleConversation={toggleConversation}
              showNewConversation={showNewConversation}
            />
