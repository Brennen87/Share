...
const PageNotFound = ({ route }) => (
  <DocumentTitle title={route.pageTitle}>
    <div className="pg404-wrapper">
      <div className="pg404-background">
        <div className="pg404-ground" />
      </div>
      <div className="pg404-container">
        <div className="pg404-left-section">
          <div className="pg404-inner-content">
            <h1 className="pg404-heading">404</h1>
            <p className="pg404-subheading">
              Looks like the page you were looking for is no longer here.
            </p>
            <Link to="/" className="pg404-link">
              Go Back
            </Link>
          </div>
        </div>
        <div className="pg404-right-section">
          <svg
            className="pg404-svgimg"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="51.5 -15.288 385 505.565"
          >
            <g className="pg404-bench-legs">
              <path
          ...
          c-1.534,0-2.778-1.243-2.778-2.777v-8.333c0-1.534,1.244-2.778,2.778-2.778h216.667c1.534,0,2.778,1.244,2.778,2.778V431.25z"
            ...
            <g className="pg404-bottom-bench">
              <path
          ...
          c0-1.534,1.244-2.778,2.778-2.778h13.889c1.534,0,2.778,1.244,2.778,2.778V93.75z"
              ...
              <circle className="pg404-lamp-light" cx="119.676" cy="44.22" r="40.51" />
              <path
                className="pg404-lamp-details"
          ...
          S149.306,67.362,149.306,71.528z"
              />
              <radialGradient
                className="pg404-light-gradient"
                id="SVGID_1_"
                cx="119.676"
                cy="44.22"
                r="65"
              ...
              <circle
                className="pg404-lamp-light__glow"
                fill="url(#SVGID_1_)"
                cx="119.676"
                cy="44.22"
                r="65"
